...
/**
  * startsWithForwardSlash - check if file starts with "/"
...
/**
  * get_file_loc - get d executable path of file
  * @path: full path variable
  * @file_name: executable file
  *
  * Return: full path to d executable file
  */
...
/**
  * get_file_path - gets d full path of the file
